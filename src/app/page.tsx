      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            This is your unified campus dashboard. From here, you can access the Learning Management System, connect with peers on CollabNest, manage your mess preferences, and much more. We're getting things set up for you.
          </p>
        </CardContent>
      </Card>
    </div>
