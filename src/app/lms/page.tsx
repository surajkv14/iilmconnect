    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-xs text-muted-foreground">
              View upcoming assignments, submit your work, and see grades.
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <p className="text-xs text-muted-foreground">
              Stay updated with the latest news and announcements from faculty.
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <p className="text-xs text-muted-foreground">
              Check your upcoming exam schedules and important dates.
            </p>
          </CardContent>
        </Card>
      </div>
